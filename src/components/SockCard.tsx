  ...
  return (
    <div className="max-w-sm w-96 lg:w-64 mx-auto bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="p-4">
        ...
        <button className=" shadow-lg w-full bg-white text-yellow-400 border border-yellow-400 hover:bg-yellow-500 hover:text-white rounded-md px-3 mt-3 py-1 transition-all">
          Order
        </button>
      </div>
    </div>
